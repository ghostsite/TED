...
public abstract class ResourceUtils {
	...
	public static boolean isResourceByClasspath(String path) throws Exception {
		Resource resource = new ClassPathResource(path.trim(),
				ClassUtils.getDefaultClassLoader());
		return (resource != null) && (resource.exists());
	}

	public static String readResourceToStringByClasspath(String path)
			throws Exception {
		Resource resource = new ClassPathResource(path.trim(),
				ClassUtils.getDefaultClassLoader());
	...
	public static Resource getResource(HttpServletRequest request, String path)
		...
		if (request == null)
			return null;
		Resource resource = new ServletContextResource(request.getSession()

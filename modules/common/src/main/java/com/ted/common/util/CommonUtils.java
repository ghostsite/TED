...
public class CommonUtils {
    ...
    /**
     * PageMetaData to JsonPage
     */
    public static JsonPage pageMetaData2JsonPage(PageMetaData pageMetaData) {
        Assert.notNull(pageMetaData);
        return new JsonPage(pageMetaData.getContent(), null, pageMetaData.getTotalElements());
    };
}

/**
 * @class (BAS.view.transaction.InputAttributeValue) Attribute Value 또는 Lot /
 *        Sub Lot 의 CMF Value 을 입력한다.
...
Ext.define('BAS.view.transaction.InputAttributeValue', {
	extend : 'MES.view.form.BaseForm',

	title : T('Caption.Menu.Input Attribute Value'),
			...
			fields : [ {
				...
				condition : [ {
					...
					value : function(me) {
						...
						return supplement.sub('cdvAttrType').getValue();
					},
					scope : this
				} ],
				disabled : true

...
Ext.define('Ext.ux.grid.RadioColumnMES', {
	extend : 'Ext.grid.column.Column',
	alias : 'widget.radiocolumnmes',
			...
			me.renderer = function(value, metaData, record, rowIndex, colIndex, store, view) {
				...
				if (checkDisabled) {
					if (value == me.inputValue) {
						cls.push(cssPrefix + 'grid-radioheader-checked-disabled');
					} else {
						cls.push(cssPrefix + 'grid-radioheader-disabled');
					} 
				} else {
					if (value == me.inputValue) {

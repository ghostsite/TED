 ...
 * 
   ...
   zhang https://github.com/loiane/extjs4-ux-paging-toolbar-resizer
 */
Ext.define('Ext.ux.PagingToolbarResizer', {
   ...
   * Defaults to [5, 10, 15, 20, 25, 30, 50, 75, 100, 200, 300, 500, 1000] //zhang changed
   */	
  options: [10, 20, 25, 50, 100, 200, 250, 500, 1000],
